...
pushd ..
cp -a zope.deprecation-4.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656359724
...
cp %{_builddir}/zope.deprecation-4.4.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-zope.deprecation/a0b53f43aab58b46bf79ba756c50771c605ab4c5
