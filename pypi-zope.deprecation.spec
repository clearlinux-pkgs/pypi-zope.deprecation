...
Source0  : https://files.pythonhosted.org/packages/48/22/0e621e31b5826b2ff121fea5b1ea91173c88f86e182181f012abcc84a51f/zope_deprecation-5.1.tar.gz
...
%prep
%setup -q -n zope_deprecation-5.1
cd %{_builddir}/zope_deprecation-5.1
pushd ..
cp -a zope_deprecation-5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736963212
...
cp %{_builddir}/zope_deprecation-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-zope.deprecation/a0b53f43aab58b46bf79ba756c50771c605ab4c5 || :
